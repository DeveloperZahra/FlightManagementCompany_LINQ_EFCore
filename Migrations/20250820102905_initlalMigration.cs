...
{
    /// <inheritdoc />
    public partial class initlalMigration : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    CrewId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    M_F_Name = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    M_L_Name = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    PassengerId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    P_F_Name = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    P_L_Name = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RouteId = table.Column<int>(type: "int", nullable: false),
                    AircraftId = table.Column<int>(type: "int", nullable: false),
                    AircraftsAircraftId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Flights_Aircrafts_AircraftsAircraftId",
                        column: x => x.AircraftsAircraftId,
                        principalTable: "Aircrafts",
                        principalColumn: "AircraftId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Flights_Routes_RoutesRouteId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CrewMembersCrewId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_FlightCrews_CrewMembers_CrewMembersCrewId",
                        column: x => x.CrewMembersCrewId,
                        principalTable: "CrewMembers",
                        principalColumn: "CrewId",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_FlightCrews_Flights_FlightsFlightId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FlightCrews_CrewMembersCrewId",
                table: "FlightCrews",
                column: "CrewMembersCrewId");

            migrationBuilder.CreateIndex(
                name: "IX_FlightCrews_FlightsFlightId",
                table: "FlightCrews",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Flights_AircraftsAircraftId",
                table: "Flights",
                column: "AircraftsAircraftId");
